...
// // import wheelImage from '/public/assets/spin-wheel.png'
...
//    <div className="w-[45%] bg-primary text-white flex flex-col justify-center items-center relative overflow-hidden">
...
//     </span>
//     <h2 className="font-extrabold text-yellow-400">
//       WIN up to ₹1 Lakh
//     </h2>
...
//     <p className="text-xs mt-3 text-gray-200">*T&C Apply</p>
//   </div>
// </div>


//       <div className="w-[55%] bg-white flex flex-col py-16">
