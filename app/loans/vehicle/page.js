    ...
    <div className="container mx-auto px-4">
      <div className="mx-auto max-w-4xl">
        <h3 className="font-bold text-center mb-6 text-gray-800">
          Key Highlights of Vehicle Loan
        </h3>
  ...
  <section id="banks" className="py-10">
    <div className="container mx-auto px-4">
      <div className="max-w-6xl mx-auto">
        <h3 className="font-bold text-center mb-6 text-gray-800">Best Banks & NBFCs Offering Vehicle Loan</h3>
    ...
    <section id="features" className="pb-10">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h3 className="font-bold text-center mb-8 text-gray-800">Features & Benefits of Vehicle Loan</h3>
...
const ApplicationProcess = ({ steps }) => (
  <section id="application" className="pb-10">
    <div className="container mx-auto px-4">
      <div className="max-w-6xl mx-auto">
        <h3 className="font-bold text-center mb-8 max-md:mb-4 text-gray-800">How to Apply for Vehicle Loan</h3>
