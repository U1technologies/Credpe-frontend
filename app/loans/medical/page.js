    ...
    <div className="container mx-auto px-4">
      <div className="mx-auto max-w-4xl">
        <h3 className="font-bold text-center mb-6 text-gray-800">
          Key Highlights of Medical Loan
        </h3>
  ...
  <section id="banks" className="py-10">
    <div className="container mx-auto px-4">
      <div className="max-w-6xl mx-auto">
        <h3 className="font-bold text-center mb-6 text-gray-800">Best Banks & NBFCs Offering Medical Loan</h3>
    ...
    <section id="features" className="pb-10">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h3 className="font-bold text-center mb-8 text-gray-800">Features & Benefits of Medical Loan</h3>
  ...
  <div className="">
    <table className="w-full text-left border-separate border-spacing-0">
      <tbody>
        ...
        <tr className="border-b border-gray-200">
          <td className="py-2 font-medium text-gray-700 border-b border-r border-gray-300">Medical Documents</td>
          <td className="py-2 text-gray-600 pl-4 border-b">
            <ul className="list-disc list-inside">
              {documents.medical.map((doc, index) => (
                <li key={index}>{doc}</li>
              ))}
            </ul>
          </td>
...
const ApplicationProcess = ({ steps }) => (
  <section id="application" className="pb-10">
    <div className="container mx-auto px-4">
      <div className="max-w-6xl mx-auto">
        <h3 className="font-bold text-center mb-8 max-md:mb-4 text-gray-800">How to Apply for Medical Loan</h3>
...
export default function MedicalLoan() {
  ...
  const content = loanContent.medical;
